<div class="woocommerce-billing-fields">
    <h3 class="title line mb-3"><?php _e('Billing details', 'woocommerce'); ?></h3>
        ...
        <?php if (!$checkout->is_registration_required()) : ?>
            ...
            <p class="form-row form-row-wide create-account">
                <div class="custom-control custom-checkbox woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                    <input class="custom-control-input woocommerce-form__input woocommerce-form__input-checkbox input-checkbox"
                    ...
                    <label class="custom-control-label" for="createaccount"><?php _e('Create an account?', 'woocommerce'); ?></label>
                </div>
            </p>
